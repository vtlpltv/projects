...
|6|[Изучение поведения клиентов приложения. Оценка результатов A/B теста](ab_test/a-a:b testing.ipynb)|Используя данные приложения изучить поведение клиентов, произвести оценку результатов A/B-тестирования|
